...
#clang++ -o build/ht_google_sparse_hash_map -DIMPL_GOOGLE_SPARSEHASHMAP -DIMPL_ALLOCATOR_STL -I../../external/sparsehash/src $ARGS
...
echo jc hashtable ch
#clang++ -o build/ht_jc_hashtable_ch -DIMPL_JC_HASHTABLE_CH -DIMPL_ALLOCATOR_NEW $ARGS
echo jc hashtable
